...
export const districtData = {
    ...
    "苗栗縣": ["苗栗市", "頭份市", "竹南鎮", "後龍鎮", "通霄鎮", "苑裡鎮", "卓蘭鎮", "大湖鄉", "公館鄉", "銅鑼鄉", "三義鄉", "西湖鄉", "造橋鄉", "頭屋鄉", "獅潭鄉", "三灣鄉", "南庄鄉", "泰安鄉"],
...
export const countyCodeMap = {
    ...
    "苗栗縣": "K", "南投縣": "M", "彰化縣": "N", "雲林縣": "P", "嘉義縣": "Q",
    "屏東縣": "T", "花蓮縣": "U", "台東縣": "V", "澎湖縣": "X", "新竹市": "O",
    "金門縣": "W", "連江縣": "Z"
};

export const SUPABASE_URL = 'https://ytpaufpxtscbteekmhko.supabase.co';
export const SUPABASE_ANON_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inl0cGF1ZnB4dHNjYnRlZWttaGtvIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MTM5NDc5MTYsImV4cCI6MjAyOTUyMzkxNn0.S-m_j-21w1 crankingYNm2il3b-3xWy-2oGo323o-ja2NA';
